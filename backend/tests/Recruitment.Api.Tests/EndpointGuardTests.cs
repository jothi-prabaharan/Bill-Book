...
/// <summary>Every Recruitment endpoint carries a guard, names its apps, and demands only seeded modules (H10, TK-57).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Recruitment.Api.Controllers.RequisitionsController).Assembly;
    ...
    public void Every_demanded_module_is_one_the_catalogue_seeds()
    {
        ...
        Assert.Contains("recruitment", seeded);

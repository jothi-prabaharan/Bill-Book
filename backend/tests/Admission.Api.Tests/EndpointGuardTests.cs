...
/// <summary>Every Admission endpoint carries a guard, names its apps, and demands only seeded modules (S2, TK-62).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Admission.Api.Controllers.InternalSeedController).Assembly;

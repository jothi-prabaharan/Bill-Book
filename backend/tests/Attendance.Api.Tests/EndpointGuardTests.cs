...
/// <summary>Every Attendance endpoint carries a guard, names its apps, and demands only seeded modules (S3, TK-63).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Attendance.Api.Controllers.InternalSeedController).Assembly;

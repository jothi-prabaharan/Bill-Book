...
/// <summary>Every Fee endpoint carries a guard, names its apps, and demands only seeded modules (S4, TK-64).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Fee.Api.Controllers.InternalSeedController).Assembly;

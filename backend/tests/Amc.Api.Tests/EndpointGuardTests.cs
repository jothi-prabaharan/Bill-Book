...
/// <summary>Every Amc endpoint carries a guard, names its apps, and demands only seeded modules (S8, TK-68).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Amc.Api.Controllers.InternalSeedController).Assembly;

...
/// <summary>Every Facility endpoint carries a guard, names its apps, and demands only seeded modules (S5, TK-65).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Facility.Api.Controllers.InternalSeedController).Assembly;

...
/// <summary>Every Performance endpoint carries a guard, names its apps, and demands only seeded modules (H11, TK-58).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Performance.Api.Controllers.ReviewCyclesController).Assembly;
    ...
    public void Every_demanded_module_is_one_the_catalogue_seeds()
    {
        ...
        Assert.Contains("performance", seeded);

...
/// <summary>Every Preventive endpoint carries a guard, names its apps, and demands only seeded modules (S7, TK-67).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Preventive.Api.Controllers.InternalSeedController).Assembly;

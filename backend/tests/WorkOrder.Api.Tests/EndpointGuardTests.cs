...
/// <summary>Every WorkOrder endpoint carries a guard, names its apps, and demands only seeded modules (S6, TK-66).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(WorkOrder.Api.Controllers.InternalSeedController).Assembly;

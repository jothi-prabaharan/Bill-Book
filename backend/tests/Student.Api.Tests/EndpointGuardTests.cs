...
/// <summary>Every Student endpoint carries a guard, names its apps, and demands only seeded modules (S1, TK-61).</summary>
public sealed class EndpointGuardTests
{
    private static System.Reflection.Assembly Service =>
        typeof(Student.Api.Controllers.InternalSeedController).Assembly;

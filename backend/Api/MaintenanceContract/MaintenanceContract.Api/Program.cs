...
// MaintenanceContract (S8, TK-68): AMC contracts, their covered assets and visits. Schema amc, port 4522. The scaffold is Employee's.
...
builder.Services.AddDbContext<MaintenanceContractDbContext>((sp, options) =>
{
    options.UseNpgsql(
...
builder.Services.AddBillBookReliability<MaintenanceContractDbContext>();
...
builder.Services.AddScoped<MaintenanceContractSeeder>();
builder.Services.AddScoped<MaintenanceContractService>();

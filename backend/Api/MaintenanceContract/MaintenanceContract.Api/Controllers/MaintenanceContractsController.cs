...
[Route("api/amc")]
public sealed class MaintenanceContractsController : ControllerBase
{
    private readonly MaintenanceContractService _amc;

    public MaintenanceContractsController(MaintenanceContractService amc) => _amc = amc;

...
namespace Inventory.Repository.Migrations
{
    ...
    public partial class AddErrorLog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("ALTER TABLE inv.\"ErrorLogs\" ENABLE ROW LEVEL SECURITY;");
            migrationBuilder.Sql("ALTER TABLE inv.\"ErrorLogs\" FORCE ROW LEVEL SECURITY;");
            migrationBuilder.Sql(
                "CREATE POLICY errorlogs_tenant_isolation ON inv.\"ErrorLogs\" " +
        ...
        {
            migrationBuilder.Sql("DROP POLICY IF EXISTS errorlogs_tenant_isolation ON inv.\"ErrorLogs\";");

...
// same transaction as the item — a failed insert gives the number back.
...
// recorded in InventoryDbContext's own ErrorLogs table, and answered with the exact
...
builder.Services.AddBillBookReliability<InventoryDbContext>();

...
/// <summary>
/// States, read from Master. A branch holds an unenforced StateId and needs the
/// state's GST code to check a branch GSTIN's first two digits — the same check
/// Contacts runs, against the same master data, because getting it wrong sends

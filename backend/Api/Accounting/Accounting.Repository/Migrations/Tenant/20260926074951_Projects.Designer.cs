...
namespace Accounting.Repository.Migrations.Tenant
{
    ...
    [Migration("20260926074951_Projects")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.AccountingApprovalStep", b =>
                {
                    b.Property<long>("AccountingApprovalStepId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("AccountingApprovalStepId"));
                    ...
                    b.HasKey("AccountingApprovalStepId");
                    ...
                    b.ToTable("ApprovalSteps", "acc");
                });

            modelBuilder.Entity("Accounting.Entity.TableEntities.AssetTransaction", b =>
                {
                    ...
                    b.HasIndex("OrgId", "FixedAssetId", "TransactionDate");

                    b.ToTable("AssetTransactions", "acc");
                });
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.BankAccount", b =>
                {
                    ...
                    b.Property<bool>("IsOnlinePaymentAccount")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.DepreciationSchedule", b =>
                {
                    b.Property<long>("DepreciationScheduleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("OrgId", "FixedAssetId", "ScheduleType")
                        .IsUnique();

                    b.ToTable("DepreciationSchedules", "acc");
                });

            modelBuilder.Entity("Accounting.Entity.TableEntities.FixedAsset", b =>
                {
                    b.Property<long>("FixedAssetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("PurchaseBillDetailId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("OrgId", "AssetCode")
                        .IsUnique();

                    b.HasIndex("OrgId", "PurchaseBillDetailId")
                        .IsUnique()
                        .HasFilter("\"PurchaseBillDetailId\" IS NOT NULL");

                    b.ToTable("FixedAssets", "acc");
                });

            modelBuilder.Entity("Accounting.Entity.TableEntities.FixedAssetCategory", b =>
                {
                    b.Property<long>("FixedAssetCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("OrgId", "CategoryName")
                        .IsUnique();

                    b.ToTable("FixedAssetCategories", "acc");
                });
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.OnlinePayment", b =>
                {
                    b.Property<long>("OnlinePaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("OnlinePaymentId"));

                    b.Property<string>("Allocations")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("OnlinePayments", "acc", t =>
                        {
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.Project", b =>
                {
                    b.Property<long>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.ProjectMember", b =>
                {
                    ...
                    b.HasIndex("OrgId", "ProjectId", "UserId")
                        .IsUnique();

                    b.ToTable("ProjectMembers", "acc");
                });

            modelBuilder.Entity("Accounting.Entity.TableEntities.ProjectMilestone", b =>
                {
                    b.Property<long>("ProjectMilestoneId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<long>("ProjectMilestoneId"));
                    ...
                    b.ToTable("ProjectMilestones", "acc");
                });

            modelBuilder.Entity("Accounting.Entity.TableEntities.ProjectTask", b =>
                {
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.AssetTransaction", b =>
                {
                    b.HasOne("Accounting.Entity.TableEntities.DepreciationSchedule", null)
                        .WithMany()
                        .HasForeignKey("DepreciationScheduleId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Accounting.Entity.TableEntities.FixedAsset", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.FixedAsset", b =>
                {
                    b.HasOne("Accounting.Entity.TableEntities.FixedAssetCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Accounting.Entity.TableEntities.JournalDetail", b =>
                {
                    ...
                    b.HasOne("Accounting.Entity.TableEntities.Project", null)
                        .WithMany()

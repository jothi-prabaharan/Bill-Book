...
/// </summary>
public class StudentDbContext : TenantDbContext
{
    public StudentDbContext(DbContextOptions<StudentDbContext> options, ITenantContext tenant)
        : base(options, tenant)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<StudentRecord>(b =>
        {
        ...
        modelBuilder.Entity<Enrolment>(b =>
        {
            ...
            b.HasOne<StudentRecord>().WithMany().HasForeignKey(e => e.StudentId).OnDelete(DeleteBehavior.Restrict);
            b.HasOne<AcademicYear>().WithMany().HasForeignKey(e => e.AcademicYearId).OnDelete(DeleteBehavior.Restrict);

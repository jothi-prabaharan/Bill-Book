...
// Student (S1, TK-61): academic years, classes, sections, subjects, students with guardians, enrolments and exams. Schema sis, port 4515. The scaffold is Employee's.
...
builder.Services.AddBillBookReliability<StudentDbContext>();
...
builder.Services.AddScoped<INumberGenerator>(sp => new NumberGenerator(
    sp.GetRequiredService<StudentDbContext>(),

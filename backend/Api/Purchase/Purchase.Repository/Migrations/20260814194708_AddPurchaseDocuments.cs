...
namespace Purchase.Repository.Migrations
{
    ...
    public partial class AddPurchaseDocuments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // IgnoreQueryFilters would read another branch's documents.
            //
            // Written here because EF will not generate it — which is not a
            // theoretical risk. The `sal` migration shipped without this block
            // even though its README carried it, so every sales document table
            // is currently protected by the query filter alone.
            foreach (string table in new[]
            {
                "PurchaseOrders", "PurchaseOrderDetails", "PurchaseOrderDetailTaxes",
                "GoodsReceipts", "GoodsReceiptDetails", "GoodsReceiptDetailTaxes",
                "Bills", "BillDetails", "BillDetailTaxes",
                "DebitNotes", "DebitNoteDetails", "DebitNoteDetailTaxes",
            })
            {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            foreach (string table in new[]
            {
                "DebitNoteDetailTaxes", "DebitNoteDetails", "DebitNotes",
                "BillDetailTaxes", "BillDetails", "Bills",
                "GoodsReceiptDetailTaxes", "GoodsReceiptDetails", "GoodsReceipts",
                "PurchaseOrderDetailTaxes", "PurchaseOrderDetails", "PurchaseOrders",
            })
            {
                migrationBuilder.Sql(
                    $"DROP POLICY IF EXISTS {table.ToLowerInvariant()}_org_isolation ON pur.\"{table}\";");

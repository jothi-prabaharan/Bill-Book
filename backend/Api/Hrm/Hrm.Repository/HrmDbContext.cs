...
/// </summary>
public class HrmDbContext : TenantDbContext
{
    public HrmDbContext(DbContextOptions<HrmDbContext> options, ITenantContext tenant)
        : base(options, tenant)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Employee>(b =>
        {
            ...
            b.HasOne<Employee>().WithMany().HasForeignKey(e => e.ReportsToEmployeeId).OnDelete(DeleteBehavior.Restrict);

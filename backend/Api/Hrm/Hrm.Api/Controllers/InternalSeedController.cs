...
/// <summary>
/// Writes Hrm's master data for an organization: one department, designation,
...
public sealed class InternalSeedController : ControllerBase
{
        ...
        [FromBody] SeedOrganizationRequest request, CancellationToken ct)
    {
        ...
        var seeder = _services.GetRequiredService<HrmSeeder>();
        ...
        _log.LogInformation(
            "Seeded Hrm for organization {OrgId}: {@Seeded}", request.OrgId, response.Seeded);

...
builder.Services.AddScoped<PortalQuoteService>();
...
// recorded in SalesDbContext's own ErrorLogs table, and answered with the exact
...
builder.Services.AddBillBookReliability<SalesDbContext>();

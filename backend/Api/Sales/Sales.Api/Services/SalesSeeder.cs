...
/// <summary>
/// Sales' master data for a newly created organization — today, its document
/// numbering series.
///
...
/// </summary>
public sealed class SalesSeeder
{
    private readonly SalesDbContext _db;

    public SalesSeeder(SalesDbContext db) => _db = db;
    ...
    public async Task<int> SeedNumberingSeriesAsync(Guid orgId, CancellationToken ct)
    {
        ...
        // is checked per code — Accounting's JRN default and Sales' QTE
        // default coexist.

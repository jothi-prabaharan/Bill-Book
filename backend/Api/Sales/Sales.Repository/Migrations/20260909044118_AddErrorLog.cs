...
namespace Sales.Repository.Migrations
{
    ...
    public partial class AddErrorLog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("ALTER TABLE sal.\"ErrorLogs\" ENABLE ROW LEVEL SECURITY;");
            migrationBuilder.Sql("ALTER TABLE sal.\"ErrorLogs\" FORCE ROW LEVEL SECURITY;");
            migrationBuilder.Sql(
                "CREATE POLICY errorlogs_tenant_isolation ON sal.\"ErrorLogs\" " +
        ...
        {
            migrationBuilder.Sql("DROP POLICY IF EXISTS errorlogs_tenant_isolation ON sal.\"ErrorLogs\";");

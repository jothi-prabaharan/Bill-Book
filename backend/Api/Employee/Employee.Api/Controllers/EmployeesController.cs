...
public sealed class EmployeesController : ControllerBase
{
    ...
    private IActionResult Refused(EmployeeOutcome outcome) => outcome switch
    {
        ...
        EmployeeOutcome.UserAlreadyLinked => Conflict(new EmployeeMessage("That login is already linked to another employee of this branch.")),
        _ => UnprocessableEntity(new EmployeeMessage(Sentence(outcome))),
    };

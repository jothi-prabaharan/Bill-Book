...
public class PreviewPrintTemplateRequest
{
    ...
    ///
    /// <b>Not served here.</b> Templates live in Printing and documents live in
    /// Sales, Purchase and Accounting; no service may read another's tables.
    /// Passing it returns a refusal: the document's own service builds its
    /// payload and posts it to <c>api/print/render</c>. Omitting it previews
    /// against sample data, which is what the editor uses.
    /// </summary>
...
/// <summary>The envelope every refusal in this product carries.</summary>

...
import { AmcContract, AmcVisit, ContractStatus, RecordVisit, SaveContract, VendorOption } from './maintenance-contract.models';

type Saved = { id: number };

/** The MaintenanceContract service's routes (S8, TK-68), behind the Gateway's `/api/amc`, and Master's vendor list. */
@Injectable({ providedIn: 'root' })
export class MaintenanceContractApiService {

...
- **Costing method per item** — weighted average, FIFO, LIFO, FEFO or specific identification, fixed once stock has moved because the earlier postings were made under it. Backdated receipts do not yet restate earlier sales.
